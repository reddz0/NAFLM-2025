...
$get_prime_league = 1;
$get_prime_division = 1;
$get_prime_tournament = 1;
...
$rules['helf'] 						= 1; 	//High Elf (teams of legend)
...
$settings['fp_standings'] = array(
	...
	array(
		...
		'title' 	=> 	'2026-27 Season Standings', //get_alt_col('divisions','did',$get_prime_division,'name'),
		'length' 	=> 	40, 
...
$settings['fp_leaders'] = array(
    ...
    array(	'id'        => $get_prime_division, #get_alt_col('tours','tour_id',$get_prime,'f_did'), # Node ID
			'box_ID'    => 6,
			'type'      => 'division',
    ...
    array(	'id'        => $get_prime_division, #get_alt_col('tours','tour_id',$get_prime,'f_did'),
			'box_ID'    => 5,
			'type'      => 'division',
    ...
    # This will display a 'Most Completions' player leaders box for the Division of the Prime Tournament
    array(	'id'        => $get_prime_division, #get_alt_col('tours','tour_id',$get_prime,'f_did'),
			'box_ID'    => 5,
			'type'      => 'division',
